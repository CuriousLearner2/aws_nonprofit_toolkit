...
class TestValidationRoute:
    ...
    def test_validation_contains_total_records(self, client):
        """Test that validation page displays total records count."""
        response = client.get('/imports/IMP-2025-0101-A/validation')
        assert b'50' in response.data

    def test_validation_table_structure(self, client):
    ...
    def test_validation_navigation_to_dashboard(self, client):
    ...
    def test_validation_navigation_to_imports(self, client):
