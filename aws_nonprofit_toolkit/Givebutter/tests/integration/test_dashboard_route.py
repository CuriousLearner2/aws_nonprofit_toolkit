...
class TestDashboardRoute:
    ...
    def test_dashboard_contains_progress(self, client):
        """Test that dashboard displays progress percentage."""
        response = client.get('/imports/IMP-2025-0101-A/dashboard')
        assert b'42%' in response.data

    def test_dashboard_contains_duplicates_queue(self, client):
    ...
    def test_dashboard_contains_validation_queue(self, client):
    ...
    def test_dashboard_contains_normalizations_queue(self, client):
    ...
    def test_dashboard_contains_households_queue(self, client):
    ...
    def test_dashboard_queue_counts(self, client):
    ...
    def test_validation_route_untouched(self, client):
